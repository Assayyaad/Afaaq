...
const lec = {
  ...
  robots: {
    name: 'مصطفى يوسف',
    title: 'كيفية بناء الآليين',
    desc: 'مقدمة في بناء الآليين والتعرف على الأجزاء الأساسية وكيفية تجميعها وبرمجتها'
  },
  controller: {
    name: 'عبدالرحمن غالب',
    title: 'تعريف بوحدة التحكم الدقيقة',
    desc: 'مقدمة في وحدات التحكم الدقيقة وكيفية استخدامها في تحكم الأجهزة الإلكترونية والآليين'
  }
}
...
export const table = {
  ...
  arr: [
    ...
    [lec.sunna, lec.robots],
    [lec.lang, lec.controller]
  ]
}
